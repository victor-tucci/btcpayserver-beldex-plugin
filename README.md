...
| --- |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| --- |
**BTCPAY_BDX_DAEMON_URI** | **Required**. The URI of the [beldexd](https://github.com/beldex-project/beldex) RPC interface.                                                                                                                                              | http://127.0.0.1:19091 |
...
**BTCPAY_BDX_WALLET_DAEMON_URI** | **Required**.  The URI of the [beldex-wallet-rpc](https://getbeldex.dev/interacting/beldex-wallet-rpc.html) RPC interface.                                                                                                                   | http://127.0.0.1:19092 |
